            ...
            <section className="w-1/2">
                ...
                <div className="w-full h-52 bg-gradient-to-r from-lime-300 to-lime-400 rounded-md my-3">
                    <div className="w-full flex justify-center pt-14">
                        <h1 className="text-3xl font-extrabold"> $ {wallet?.balance.toFixed(2) || 0}</h1>
                    </div>
            ...
            <section className="w-1/2 ml-5">
                ...
                <div className="h-72 overflow-y-scroll border border-gray-200 rounded-md p-3 bg-white">
                    {wallet?.transactions.length === 0 ? (
                        ...
                        wallet?.transactions.map((transaction: { id: React.Key | null | undefined; transactionType: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined; date: string; amount: number; }) => (
                            <div
                                key={transaction.id}
